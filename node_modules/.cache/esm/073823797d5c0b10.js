let User,Event,Email,Donor,passport,requestt,request,_,util,deleteProfileImage,crypto,sgMail;_7d5‍.x([["getIndex",()=>getIndex],["postForm",()=>postForm],["donate",()=>donate],["getDonate",()=>getDonate],["emailSignup",()=>emailSignup],["getFacebookLogin",()=>getFacebookLogin],["postFacebookLogin",()=>postFacebookLogin],["getRegister",()=>getRegister],["postRegister",()=>postRegister],["getLogin",()=>getLogin],["postLogin",()=>postLogin],["getLogout",()=>getLogout],["getProfile",()=>getProfile],["updateProfile",()=>updateProfile],["forgotPassword",()=>forgotPassword],["putForgotPassword",()=>putForgotPassword],["resetPassword",()=>resetPassword],["putResetPassword",()=>putResetPassword]]);_7d5‍.w("../models/user",[["default",["User"],function(v){User=v}]]);_7d5‍.w("../models/event",[["default",["Event"],function(v){Event=v}]]);_7d5‍.w("../models/email-signup",[["default",["Email"],function(v){Email=v}]]);_7d5‍.w("../models/donate",[["default",["Donor"],function(v){Donor=v}]]);_7d5‍.w("passport",[["default",["passport"],function(v){passport=v}]]);_7d5‍.w("superagent",[["default",["requestt"],function(v){requestt=v}]]);_7d5‍.w("request",[["default",["request"],function(v){request=v}]]);_7d5‍.w("lodash",[["default",["_"],function(v){_=v}]]);_7d5‍.w("util",[["default",["util"],function(v){util=v}]]);_7d5‍.w("../middleware",[["default",["deleteProfileImage"],function(v){deleteProfileImage=v}]]);_7d5‍.w("crypto",[["default",["crypto"],function(v){crypto=v}]]);_7d5‍.w("@sendgrid/mail",[["default",["sgMail"],function(v){sgMail=v}]]);require('dotenv').config()
...
const {initializePayment, verifyPayment} = require('../config/paystack')(request);
  ...
  const form = _.pick(req.body,['amount','email','full_name']);
    ...
    initializePayment(form, (error, body)=>{
        if(error){
            //handle errors
            _7d5‍.g.console.log(error);
            return res.redirect('/');
       }
       let response = JSON.parse(body);
       _7d5‍.g.console.log(response)
       res.redirect(response.data.authorization_url)
    });
}

       const getDonate = (req, res, next) => {
