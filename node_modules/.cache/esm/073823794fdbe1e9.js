let User,Email,passport,nodemailer,request;_4fd‍.x([["getIndex",()=>getIndex],["postForm",()=>postForm],["emailSignup",()=>emailSignup],["getFacebookLogin",()=>getFacebookLogin],["postFacebookLogin",()=>postFacebookLogin],["getRegister",()=>getRegister],["postRegister",()=>postRegister],["getLogin",()=>getLogin],["postLogin",()=>postLogin],["getLogout",()=>getLogout]]);_4fd‍.w("../models/user",[["default",["User"],function(v){User=v}]]);_4fd‍.w("../models/email-signup",[["default",["Email"],function(v){Email=v}]]);_4fd‍.w("passport",[["default",["passport"],function(v){passport=v}]]);_4fd‍.w("nodemailer",[["default",["nodemailer"],function(v){nodemailer=v}]]);_4fd‍.w("superagent",[["default",["request"],function(v){request=v}]]);require('dotenv').config()
...
${req.body.message}
  ...
  await smtpTrans.sendMail(mailOpts, (error, response) => {
    if (error) {
      _4fd‍.g.console.log(error);
      res.redirect('/');
    } else {
      _4fd‍.g.console.log(response);
      res.redirect('/');
    }
  });
}
