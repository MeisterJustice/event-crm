let Event,Blog,TicketPurchase,cloudinary,_,request,sgMail,crypto;_5ef‍.x([["getEvent",()=>getEvent],["getCreateEvent",()=>getCreateEvent],["postEvent",()=>postEvent],["showEvent",()=>showEvent],["getEdit",()=>getEdit],["putEvent",()=>putEvent],["deleteEvent",()=>deleteEvent],["purchaseTicket",()=>purchaseTicket],["ticketCallback",()=>ticketCallback]]);_5ef‍.w("../models/event",[["default",["Event"],function(v){Event=v}]]);_5ef‍.w("../models/blog",[["default",["Blog"],function(v){Blog=v}]]);_5ef‍.w("../models/ticketPurchase",[["default",["TicketPurchase"],function(v){TicketPurchase=v}]]);_5ef‍.w("../cloudinary",[["cloudinary",["cloudinary"],function(v){cloudinary=v}]]);_5ef‍.w("lodash",[["default",["_"],function(v){_=v}]]);_5ef‍.w("request",[["default",["request"],function(v){request=v}]]);_5ef‍.w("@sendgrid/mail",[["default",["sgMail"],function(v){sgMail=v}]]);_5ef‍.w("crypto",[["default",["crypto"],function(v){crypto=v}]]);
...
// }
    ...
    const form = await _.pick(req.body,['amount','email','full_name']);
      ...
      await initializePayment(form, (error, body)=>{
          if(error){
              _5ef‍.g.console.log(error);
              return;
         }
         const response = JSON.parse(body)
         _5ef‍.g.console.log(response);
