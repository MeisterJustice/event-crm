let User,Event,Blog,Email,Donor,passport,requestt,request,_,util,deleteProfileImage,crypto,sgMail;_e09‍.x([["getIndex",()=>getIndex],["privacy",()=>privacy],["postForm",()=>postForm],["donate",()=>donate],["getCallback",()=>getCallback],["emailSignup",()=>emailSignup],["getFacebookLogin",()=>getFacebookLogin],["postFacebookLogin",()=>postFacebookLogin],["getRegister",()=>getRegister],["postRegister",()=>postRegister],["getLogin",()=>getLogin],["postLogin",()=>postLogin],["getLogout",()=>getLogout],["getProfile",()=>getProfile],["updateProfile",()=>updateProfile],["forgotPassword",()=>forgotPassword],["putForgotPassword",()=>putForgotPassword],["resetPassword",()=>resetPassword],["putResetPassword",()=>putResetPassword]]);_e09‍.w("../models/user",[["default",["User"],function(v){User=v}]]);_e09‍.w("../models/event",[["default",["Event"],function(v){Event=v}]]);_e09‍.w("../models/blog",[["default",["Blog"],function(v){Blog=v}]]);_e09‍.w("../models/email-signup",[["default",["Email"],function(v){Email=v}]]);_e09‍.w("../models/donate",[["default",["Donor"],function(v){Donor=v}]]);_e09‍.w("passport",[["default",["passport"],function(v){passport=v}]]);_e09‍.w("superagent",[["default",["requestt"],function(v){requestt=v}]]);_e09‍.w("request",[["default",["request"],function(v){request=v}]]);_e09‍.w("lodash",[["default",["_"],function(v){_=v}]]);_e09‍.w("util",[["default",["util"],function(v){util=v}]]);_e09‍.w("../middleware",[["deleteProfileImage",["deleteProfileImage"],function(v){deleteProfileImage=v}]]);_e09‍.w("crypto",[["default",["crypto"],function(v){crypto=v}]]);_e09‍.w("@sendgrid/mail",[["default",["sgMail"],function(v){sgMail=v}]]);require('dotenv').config()
...
const {initializePayment, verifyPayment} = require('../config/paystack')(request);
  ...
  const form = _.pick(req.body,['amount','email','full_name']);
    ...
    initializePayment(form, (error, body)=>{
        if(error){
            //handle errors
            _e09‍.g.console.log(error);
            return;
       }
       const response = JSON.parse(body);
       _e09‍.g.console.log(response);
