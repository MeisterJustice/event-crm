let User,Email,passport,nodemailer,request;_62a‍.x([["getIndex",()=>getIndex],["postForm",()=>postForm],["emailSignup",()=>emailSignup],["getFacebookLogin",()=>getFacebookLogin],["postFacebookLogin",()=>postFacebookLogin],["getRegister",()=>getRegister],["postRegister",()=>postRegister],["getLogin",()=>getLogin],["postLogin",()=>postLogin],["getLogout",()=>getLogout]]);_62a‍.w("../models/user",[["default",["User"],function(v){User=v}]]);_62a‍.w("../models/email-signup",[["default",["Email"],function(v){Email=v}]]);_62a‍.w("passport",[["default",["passport"],function(v){passport=v}]]);_62a‍.w("nodemailer",[["default",["nodemailer"],function(v){nodemailer=v}]]);_62a‍.w("superagent",[["default",["request"],function(v){request=v}]]);require('dotenv').config()
...
${req.body.message}
  ...
  await smtpTrans.sendMail(mailOpts, (error, response) => {
    if (error) {
      _62a‍.g.console.log(error);
      res.redirect('/');
    } else {
      _62a‍.g.console.log(response);
      res.redirect('/');
    }
  });
}
